...
- Basic concepts of flexbox [# Flexbox
...
- Use [this CSS-Tricks Flexbox guide](https://css-tricks.com/snippets/css/a-guide-to-flexbox/) as a reference.
- Practice your knowledge with the [Flexbox Froggy interactive tutorial](http://flexboxfroggy.com/).
- Basic concepts of flexbox [CSS_Flexible_Box_Layout](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox)
- CSS Flexbox and Grid Tutorial [How to Build a Responsive Landing Page with HTML and CSS](https://www.freecodecamp.org/news/css-flexbox-and-grid-tutorial/)
